...
if __name__ == "__main__":
    ...
    data1 = np.column_stack((two_thetas,spectra1_smeared))   # for uspex 220916
    np.savetxt(sys.argv[1].split('.csv')[0]+'_smeared_xrd.csv',data1,delimiter=',')   # for uspex 220916
    ...
    w.write_file(sys.argv[2].split('.cif')[0]+'_volchanged.cif')    ### 220914 modified
